...
FILES = [
    ...
    # --- batch 2: files missed in initial scan ---
    '404.html',
    'beach.html',
    'contact.html',
    'en/about.html',
    'en/contact.html',
    'en/media-kit.html',
    'en/northern-portugal-beaches.html',
    'en/parceiros.html',
    'en/planear.html',
    'en/precos.html',
    ...
    'media-kit.html',
    'onde-ficar-lisboa-setubal-praia.html',
    'parceiros.html',
    'planear.html',
    'praias-alentejo-costa.html',
    'praias-algarve.html',
    'praias-calmas-algarve.html',
    'praias-centro-portugal.html',
    'praias-familias-algarve.html',
    'praias-norte-portugal.html',
    'praias-para-criancas-portugal.html',
    'praias-para-surfistas-iniciantes-portugal.html',
    'praias-perto-lisboa.html',
    'praias-secretas-algarve.html',
    'precos.html',
    'surf-algarve.html',
]
